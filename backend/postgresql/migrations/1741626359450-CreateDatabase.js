...
export class CreateDatabase1741626359450 {
    name = 'CreateDatabase1741626359450'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "attendances" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "check_in" TIMESTAMP NOT NULL, "check_out" TIMESTAMP, "employee_id" character varying NOT NULL, "facility_id" uuid NOT NULL, CONSTRAINT "PK_483ed97cd4cd43ab4a117516b69" PRIMARY KEY ("id"))`);
