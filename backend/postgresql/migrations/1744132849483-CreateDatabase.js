...
export class CreateDatabase1744132849483 {
    name = 'CreateDatabase1744132849483'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "attendances" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "check_in" TIME NOT NULL, "check_out" TIME, "employee_id" character varying NOT NULL, "facility_id" uuid NOT NULL, "note" text NOT NULL, CONSTRAINT "PK_483ed97cd4cd43ab4a117516b69" PRIMARY KEY ("id"))`);
